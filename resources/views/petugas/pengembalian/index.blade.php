                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="tool-list-container align-items-center">
                            ...
                            <div class="tool-item-approve mx-auto" style="max-width: 300px; border: 1px solid rgba(99, 102, 241, 0.2);">
                                {{-- NAMA ALAT DIBUAT SANGAT JELAS DI SINI --}}
                                <span class="font-black text-white" style="font-size: 14px; text-shadow: 0 2px 4px rgba(0,0,0,0.3);">
                                    {{ $detail->alat->nama_alat ?? 'Alat Dihapus' }}
                                </span>
                                <span class="qty-label-bold">x{{ $detail->jumlah }}</span>
                            </div>
                            @endforeach
                        </div>
                    </td>
